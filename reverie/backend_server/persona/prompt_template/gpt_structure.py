...
from utils import *
from persona.prompt_template.llm_provider import chat_request, completion_request, get_embedding_vec
...
def GPT4_request(prompt):
  ...
  try:
    return chat_request(prompt, model="gpt-4")
  except:
    print ("ChatGPT ERROR")
...
def GPT_request(prompt, gpt_parameter):
  ...
  temp_sleep()
  try:
    return completion_request(prompt, gpt_parameter)
